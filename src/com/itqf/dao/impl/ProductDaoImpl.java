...
public class ProductDaoImpl implements ProductDao {
    ...
    @Override
    public long selectCount(String tid) throws SQLException {
        QueryRunner queryRunner = new QueryRunner(C3P0Utils.getDataSource());
        String sql = "select count(1) as ct from product where t_id = ?";
    ...
    @Override
    public List<Product> selectProductByPage(String tid, int page, int pageSize) throws SQLException {
